  ...
  var dragEl,
    ...
    _detectDirection = function(el, options) {
      var elCSS = _css(el),
        ...
        firstChildWidth =
          firstChildCSS &&
          parseInt(firstChildCSS.marginLeft) + parseInt(firstChildCSS.marginRight) + _getRect(child1).width,
        secondChildWidth =
          secondChildCSS &&
          parseInt(secondChildCSS.marginLeft) + parseInt(secondChildCSS.marginRight) + _getRect(child2).width
    ...
    _isElInRowColumn = function(el1, el2, axis) {
      ...
      return (
        el1S1Opp === el2S1Opp || el1S2Opp === el2S2Opp || el1S1Opp + el1OppLength / 2 === el2S1Opp + el2OppLength / 2
      )
    },
      ...
      if (options.scroll) {
        ...
        do {
          ...
          if (el !== win) {
            ...
            canScrollX =
              width < scrollWidth &&
              (css.overflowX === 'auto' || css.overflowX === 'scroll' || css.overflowX === 'visible')
            canScrollY =
              height < scrollHeight &&
              (css.overflowY === 'auto' || css.overflowY === 'scroll' || css.overflowY === 'visible')
          ...
          vx =
            canScrollX &&
            (abs(right - x) <= sens && scrollPosX + width < scrollWidth) - (abs(left - x) <= sens && !!scrollPosX)

          vy =
            canScrollY &&
            (abs(bottom - y) <= sens && scrollPosY + height < scrollHeight) - (abs(top - y) <= sens && !!scrollPosY)
  ...
  Sortable.prototype = /** @lends Sortable.prototype */ {
    ...
    _animate: function(prevRect, target) {
      ...
      if (ms) {
        ...
        if (
          prevRect.left + prevRect.width / 2 !== currentRect.left + currentRect.width / 2 ||
