...
class ThingsPlayerEnlargeGrid extends LitElement {
  static get is() {
    return 'things-player-enlarge-grid'
  }
...
customElements.define(ThingsPlayerEnlargeGrid.is, ThingsPlayerEnlargeGrid)
